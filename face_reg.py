...
st.markdown("<h1 style = 'color: #FF4B4B'>FACE DETECTION APP</h1> ", unsafe_allow_html = True)
st.markdown("<h6 style = 'top_margin: 0rem; color: #F2921D'>Built by Eme Ita</h6>", unsafe_allow_html = True)

# Add an image to the page
#st.image('pngwing.com (28).png', caption = 'FACE DETECTOR', width = 400)
